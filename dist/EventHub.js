...
const EventHub = function (jQuery, firebase)
{
     ...
     */
    EventHub.prototype.getVotingApp = function ()
    {
    ...
    EventHub.prototype.getVotingDb = function (firebase)
    {
     ...
     */
    EventHub.prototype.getLock = function ()
    {
     ...
     * Destroy Auth0 token
     */
    EventHub.prototype.logout = function () {
     ...
     */
    EventHub.prototype.onLockAuthenticated = function (authResult)
    {
        let me = this;
     ...
     */
    EventHub.prototype.firebaseSignin = function (jwtToken)
    {
