...
my @pokies = qw(
	...
	ledian spinarak ariados crobat chinchou lanturn pichu cleffa igglybuff
	...
	wailmer wailord numel camerupt torkoal spoink grumpig spinda trapinch
	...
	axew fraxure haxorus cubchoo beartic cryogonal shelmet accelgor
	stunfisk mienfoo mienshao druddigon golett golurk pawniard bisharp
	bouffalant rufflet braviary vullaby mandibuzz heatmor durant deino
	...
	froakie frogadier greninja bunnelby diggersby fletchling fletchinder
	talonflame scatterbug spewpa vivillon litleo pyroar flabébé floette
	florges skiddo gogoat pancham pangoro furfrou espurr meowstic honedge
	...
	incineroar popplio brionne primarina pikipek trumbeak toucannon
	yungoos gumshoos grubbin charjabug vikavolt crabrawler crabominable
	oricorio cutiefly ribombee rockruff lycanroc wishiwashi mareanie
...
sub main {
	...
	foreach my $i (0 .. $#pokies) {
		...
		#system qq!curl $base$pokie > types/$filename ! and die "Error";
		system qq!curl $base$pokie | ./filter-types.pl > types/$filename ! and die "Error";
	}
}
